...
//HINT: Return the Floating-Point Accrued Exceptions
uint32_t core_get_fflags(void)
{
	uint32_t result;
...
//HINT: Set the Floating-Point Accrued Exceptions
void core_set_fflags(uint32_t value)
{
	__asm volatile ("csrw fflags, %0" : : "r" (value) );
}

//HINT: Return the Floating-Point Dynamic Rounding Mode
uint32_t core_get_frm(void)
{
	uint32_t result;
...
//HINT: Set the Floating-Point Dynamic Rounding Mode
void core_set_frm(uint32_t value)
{
	__asm volatile ("csrw frm, %0" : : "r" (value) );
}

//HINT: Return the Floating-Point Control and Status Register
uint32_t core_get_fcsr(void)
{
	uint32_t result;
...
//HINT: Set the Floating-Point Control and Status Register
void core_set_fcsr(uint32_t value)
{
