...
#ifndef _CH32V307_DMA_H_
#define _CH32V307_DMA_H_

#define DMA1_IMPLEMENT_ISR 0
#define DMA2_IMPLEMENT_ISR 1
...
extern void (*dma2_channel1_callback)(void);
extern void (*dma2_channel2_callback)(void);
extern void (*dma2_channel3_callback)(void);
extern void (*dma2_channel4_callback)(void);
extern void (*dma2_channel5_callback)(void);
extern void (*dma2_channel6_callback)(void);
extern void (*dma2_channel7_callback)(void);
extern void (*dma2_channel8_callback)(void);
extern void (*dma2_channel9_callback)(void);
extern void (*dma2_channel10_callback)(void);
extern void (*dma2_channel11_callback)(void);
#endif
