...
user_libs/%.o: ../user_libs/%.c
	...
	riscv-none-embed-gcc -march=rv32imac -mabi=ilp32 -msmall-data-limit=8 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -I"/media/dragomir/lnx_hdd/lnx_home/repos/mcu_libs/CH32V203/ch32v203_usbd_cdc/user_libs" -I"/media/dragomir/lnx_hdd/lnx_home/repos/mcu_libs/CH32V203/ch32v203_usbd_cdc/Debug" -I"/media/dragomir/lnx_hdd/lnx_home/repos/mcu_libs/CH32V203/ch32v203_usbd_cdc/User" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
