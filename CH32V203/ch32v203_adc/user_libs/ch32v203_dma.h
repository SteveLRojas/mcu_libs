...
#define dma_is_enabled(channel) ((channel)->CFGR & DMA_CFG_ENABLE)
#define dma_enable(channel) ((channel)->CFGR |= DMA_CFG_ENABLE)
#define dma_disable(channel) ((channel)->CFGR &= ~DMA_CFG_ENABLE)
#define dma_set_mem_addr(channel, mem_addr) ((channel)->MADDR = (uint32_t)(mem_addr))
#define dma_set_periph_addr(channel, periph_addr) ((channel)->PADDR = (periph_addr))
#define dma_set_num_words(channel, num_words) ((channel)->CNTR = (num_words))
