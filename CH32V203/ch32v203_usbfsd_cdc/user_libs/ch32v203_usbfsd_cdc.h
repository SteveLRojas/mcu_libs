/*
 * ch32v203_usbfsd_cdc.h
 *
 *  Created on: Aug 27, 2024
 *      Author: Steve
 */

#ifndef _CH32V203_USBFSD_CDC_H_
#define _CH32V203_USBFSD_CDC_H_
...
// CH32V203 writes the CRC when receiving: the buffer can be overflown by up to 2 bytes, but never past 64 bytes...
