#ifndef _CH547_GPIO_H_
#define _CH547_GPIO_H_
...
//HINT: P5 is not configurable, P55 is open-drain, P54 is PP, other P5 pins are input only.
...
#define GPIO_INT_P4_6_FALL	0x02
